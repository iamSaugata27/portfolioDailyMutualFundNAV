...
namespace DailyMutualFundNAVMicroservice.Repository
{
    public class MutualFundRepository:IMutualFundRepository
    {
        ...
        { 
            ...
            new MutualFundDetails { MutualFundId = 2, MutualFundName = "AXIS", MutualFundValue = 100.14},
            new MutualFundDetails { MutualFundId = 3, MutualFundName = "CRED", MutualFundValue = 104.14}
        };
          /// <summary>
